# 🛣️ Deep Learning Based Road Damage Detection

## 📌 Abstract
This research project focuses on automating the detection of road infrastructure damage (cracks, potholes) using Computer Vision and Deep Learning. The study involves a rigorous comparative analysis of **6 distinct CNN models** to identify the most efficient architecture for real-time deployment.
...
## 🛠️ Tech Stack
- **Language:** Python
- **Libraries:** TensorFlow, Keras, OpenCV, Pandas, Matplotlib, Scikit-learn
